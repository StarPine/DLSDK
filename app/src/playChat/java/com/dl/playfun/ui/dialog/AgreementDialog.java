...
public class AgreementDialog extends BaseDialogFragment implements View.OnClickListener {
    ...
    public void startCountDown() {
        ...
        Flowable.intervalRange(0, maxSeconds + 1, 0, 1, TimeUnit.SECONDS)
                ...
                .doOnNext(aLong -> {
                    btnAgree.setText(String.format(getString(R.string.agree_second), maxSeconds - aLong.intValue()));
                })
                .doOnComplete(() -> {
                    btnAgree.setText(getString(R.string.dialog_agree));
    ...
    private SpannableString generateSp() {
        ...
        SpannableString spannableString = new SpannableString(getString(R.string.check_protocol_criterion));
