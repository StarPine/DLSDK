...
public class GuessYouLikeDialog extends BaseDialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            tvAddress1.setText(String.format(getString(R.string.age_and_city), user1.getAge(), user1.getCityName()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            tvAddress2.setText(String.format(getString(R.string.age_and_city), user2.getAge(), user2.getCityName()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            tvAddress3.setText(String.format(getString(R.string.age_and_city), user3.getAge(), user3.getCityName()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            tvAddress4.setText(String.format(getString(R.string.age_and_city), user4.getAge(), user4.getCityName()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (likeRecommendEntity.getPrice() > 0) {
            if (Injection.provideDemoRepository().readUserData().getSex() == 1) {
                btnCall.setText(String.format(getString(R.string.call_female_im), likeRecommendEntity.getPrice()));
            } else {
                btnCall.setText(String.format(getString(R.string.call_male_im), likeRecommendEntity.getPrice()));
            }
