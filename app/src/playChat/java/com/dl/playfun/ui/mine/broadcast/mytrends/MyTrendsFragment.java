...
import com.dl.playfun.databinding.FragmentMyTrendsBinding;
...
//                        .setAnimationStyle(R.style.RightPopAnim)
                ...
                stop.setText(viewModel.observableList.get((Integer) o).newsEntityObservableField.get().getBroadcast().getIsComment() == 0 ? getString(R.string.fragment_issuance_program_no_comment) : getString(R.string.open_comment));
