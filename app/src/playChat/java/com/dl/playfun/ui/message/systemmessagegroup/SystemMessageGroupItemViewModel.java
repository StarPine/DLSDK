...
public class SystemMessageGroupItemViewModel extends MultiItemViewModel<SystemMessageGroupViewModel> {
    ...
    public String getTitleName() {
        switch (itemEntity.get().getMold()) {
            case "system":
                return StringUtils.getString(R.string.system_message);
            case "sign":
                return StringUtils.getString(R.string.sign_message_title);
            case "give":
                return StringUtils.getString(R.string.fragment_give_list_title);
            case "evaluate":
                return StringUtils.getString(R.string.fragment_evaluate_message_title);
            case "comment":
                return StringUtils.getString(R.string.fragment_custom_chat_input_title);
            case "broadcast":
                return StringUtils.getString(R.string.fragment_broadcast_message_title);
            case "apply":
                return StringUtils.getString(R.string.application_erad);
            case "profit":
                return StringUtils.getString(R.string.profit_message_title);
            default:
