 ...
 * Description: This is PlayGameViewModel1
 */
public class PlayGameViewModel1 extends BaseViewModel<AppRepository> {

    public UIChangeObservable uc = new UIChangeObservable();

    public PlayGameViewModel1(@NonNull @NotNull Application application, AppRepository model) {
    ...
    public class UIChangeObservable {
        ...
        //加载弹窗
        public SingleLiveEvent<Void> loadCoinSheet = new SingleLiveEvent<>();
    }
}
