...
public class SettingViewModel extends BaseViewModel<AppRepository> {
    ...
    //绑定社群账号
    public BindingCommand bindingCommunityAccount = new BindingCommand(() -> start(CommunityAccountFragment.class.getCanonicalName()));
    //推送设置按钮的点击事件
    ...
    public BindingCommand clearCacheOnClickCommand = new BindingCommand(() -> {
        ...
        ToastUtils.showShort(R.string.cleared_image_cache);
    });
