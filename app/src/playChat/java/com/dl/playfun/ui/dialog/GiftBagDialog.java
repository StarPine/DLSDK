...
public class GiftBagDialog extends BaseDialog{
    ...
    private RelativeLayout gift_check_number;//礼物数量选择
...
//                        .setAnimationStyle(R.style.RightPopAnim)
                ...
                if(isDark){
                    LinearLayout containerProp = mCirclePop.findViewById(R.id.container_prop);
                ...
                mCirclePop.findViewById(R.id.text_layout1).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        gift_number.setText(value+ StringUtils.getString(R.string.individual));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(giftOnClickListener!=null){
                    Integer balanceValue = Integer.parseInt(balance_value.getText().toString());
                    balanceValue = balanceValue - checkGiftItemEntity.getMoney();
                    balance_value.setText(balanceValue <= 0 ? "0" : String.valueOf(balanceValue));
                ...
                .subscribe(new BaseObserver<BaseDataResponse<GiftBagEntity>>(){
                    ...
                    public void onSuccess(BaseDataResponse<GiftBagEntity> response) {
                        ...
                        if (isFirst != null && isFirst == 1) {
                            ...
                            btn_stored.setText(R.string.gift_bag_text1);
                        }
                        int totalCoin = giftBagEntity.getTotalCoin().intValue();
                        if (ConfigManager.getInstance().isMale() && isDark) {
