...
public class ScreenLockViewModel extends BaseViewModel<AppRepository> {
    ...
    public void onViewCreated() {
        ...
        if (StringUtil.isEmpty(password)) {
            isUpdata = false;
            title.set(StringUtils.getString(R.string.setting_screen_lock));
        } else {
            isUpdata = true;
            title.set(StringUtils.getString(R.string.update_screen_lock));
        }
    }
    ...
    public void setPassword(String str) {
        ...
        if (!StringUtil.isEmpty(str)) {
            if (str.length() < 4) {
                ...
                passwordExplain.set(StringUtils.getString(R.string.least_fount_points));
            } else {
                if (StringUtil.isEmpty(password)) {
                    password = str;
                    isExplainVisibility.set(true);
                    passwordExplain.set(StringUtils.getString(R.string.please_again_draw));
                } else {
                    if (password.equals(str)) {
                        if (isUpdata) {
                            ...
                            passwordExplain.set(StringUtils.getString(R.string.setting_success));
                        ...
                        if (isUpdata) {
                            ...
                            passwordExplain.set(StringUtils.getString(R.string.draw_wrong_again_draw));
                            ...
                            isExplainVisibility.set(true);
                            colorval.set(getColor(R.color.red_7c));
                            passwordExplain.set(StringUtils.getString(R.string.two_draw_different));
                        }
                    }
                }
