    ...
    public void initViewObservable() {
        ...
        viewModel.uc.loadRefresh.observe(this, new Observer<Void>() {
            ...
            public void onChanged(Void unused) {
                binding.title.setText(String.format(StringUtils.getString(R.string.mine_trace_man_title1), viewModel.totalCount));
        ...
        viewModel.uc.clickVip.observe(this, new Observer<Void>() {
            ...
            public void onChanged(Void unused) {
                ...
                vipDialog = TraceDialog.getInstance(TraceManFragment.this.getContext())
                        ...
                        .setConfirmText(String.format(StringUtils.getString(R.string.mine_trace_man_play_confirm), ConfigManager.getInstance().GetViewUseBrowseMoney()))
                        .setConfirmOnlick(new TraceDialog.ConfirmOnclick() {
                            @Override
                            public void confirm(Dialog dialog) {
                                dialog.dismiss();
                                new CoinPaySheet.Builder(mActivity).setPayParams(13, userId, getString(R.string.mine_trace_man_play_title), false, new CoinPaySheet.CoinPayDialogListener() {
                                    @Override
