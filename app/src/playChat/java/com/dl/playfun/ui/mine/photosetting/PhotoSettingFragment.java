...
import com.dl.playfun.databinding.FragmentPhotoSettingBinding;
    ...
    public void initViewObservable() {
        ...
        viewModel.uc.clickDelete.observe(this, index -> {
            ...
            if (src.toLowerCase().endsWith(".jpg") || src.toLowerCase().endsWith(".jpeg") || src.toLowerCase().endsWith(".png")) {
                title = getString(R.string.dialog_delete_photo_content);
            } else {
                title = getString(R.string.dialog_delete_video_content);
            }
