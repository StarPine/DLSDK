...
//        });
        ...
        viewModel.uc.clickPrivacy.observe(this, aVoid -> {
            String[] items = new String[]{getString(R.string.public_recommended), getString(R.string.pay_to_unlock), getString(R.string.need_verify_look)};
            ...
            new BottomSheet.Builder(mActivity)
                    ...
                    .setTitle(getString(R.string.mine_album_privacy))
                    .setDatas(items)
                        ...
                        if (position == 0) {
                            ...
                            if (viewModel.userInfoEntity.get().getSex() == 0 && viewModel.userInfoEntity.get().getIsVip() != 1) {
                                MVDialog.getInstance(MineFragment.this.getContext())
                                        .setTitle(getStringByResId(R.string.goddess_unlock_payalbum))
                                        .setConfirmText(getStringByResId(R.string.goddess_certification))
                            ...
                            String msg = String.format(getString(R.string.mine_contrnt_one),
                                    viewModel.userInfoEntity.get().getSex() == 1 ? getString(R.string.non_certified_lady) : getString(R.string.non_certified_man),
                                    viewModel.userInfoEntity.get().getSex() == 1 ? getString(R.string.certified_lady) : getString(R.string.certified_man));
                            MVDialog.getInstance(MineFragment.this.getContext())
                                    .setContent(msg)
                                    .setConfirmText(getString(R.string.carry_on))
                                    .setConfirmOnlick(new MVDialog.ConfirmOnclick() {
                                        @Override
                                        public void confirm(MVDialog dialog) {
                                            dialog.dismiss();
                                            MVDialog.getInstance(MineFragment.this.getContext())
                                                    .setTitle(getString(R.string.set_view_amount))
                            ...
                            String msg = String.format(getString(R.string.mine_contrnt_two), viewModel.userInfoEntity.get().getSex() == 1 ? getString(R.string.lady) : getString(R.string.man));
                            MVDialog.getInstance(MineFragment.this.getContext())
                                    .setContent(msg)
                                    .chooseType(MVDialog.TypeEnum.CENTER)
                                    .setConfirmOnlick(new MVDialog.ConfirmOnclick() {
        ...
        viewModel.uc.clickSetRedPackagePhoto.observe(this, new Observer<Void>() {
            @Override
            public void onChanged(Void aVoid) {
                String[] items = new String[]{getString(R.string.mine_set_redpackage_photo), getString(R.string.setting_red_video)};
                new BottomSheet.Builder(mActivity)
                        ...
                        .setOnItemSelectedListener(new BottomSheet.ItemSelectedListener() {
                            ...
                            public void onItemSelected(BottomSheet bottomSheet, int position) {
                                ...
                                if (viewModel.userInfoEntity.get().getIsVip() != 1) {
                                    MVDialog.getInstance(MineFragment.this.getContext())
                                            .setTitle(getStringByResId(R.string.goddess_unlock_redpackage_photo))
                                            .setConfirmText(getStringByResId(R.string.goddess_certification))
                                            .setConfirmOnlick(new MVDialog.ConfirmOnclick() {
                                                @Override
                                                public void confirm(MVDialog dialog) {
        ...
        viewModel.uc.clickRecoverBurn.observe(this, new Observer<Void>() {
            ...
            public void onChanged(Void aVoid) {
                MVDialog.getInstance(MineFragment.this.getContext())
                        .setContent(getString(R.string.dialog_recover_burn_content))
                        .setConfirmOnlick(new MVDialog.ConfirmOnclick() {
                            @Override
                            public void confirm(MVDialog dialog) {
                                dialog.dismiss();
