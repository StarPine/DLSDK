                ...
                .subscribe(event -> {
                    if (userDisableDialog == null) {
                        userDisableDialog = MVDialog.getInstance(MainContainerActivity.this)
                                .setTitle(getString(R.string.dialog_user_disable_title))
                                .setContent(getString(R.string.dialog_user_disable_content))
                                .setConfirmText(getString(R.string.dialog_user_disable_btn_text))
                                .setCancelable(true)
                ...
                .subscribe(event -> {
                    ...
                    if (loginExpiredDialog == null) {
                        loginExpiredDialog = MVDialog.getInstance(this)
                                .setContent(getString(R.string.again_login))
