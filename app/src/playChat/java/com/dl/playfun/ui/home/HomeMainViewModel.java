...
public class HomeMainViewModel extends BaseViewModel<AppRepository> {
    ...
    public ObservableField<String> regionTitle = new ObservableField<>(StringUtils.getString(R.string.tab_female_1));
    ...
    //显示隐藏任务中心
    public ObservableField<Boolean> showTasks = new ObservableField<>(true);
    ...
    public BindingCommand taskCloseClickCommand = new BindingCommand(() -> {
        showTasks.set(false);
    });
...
//            CityChoiceDialog dialog = new CityChoiceDialog();
    ...
    public BindingCommand genderOnClickCommand = new BindingCommand(() -> {
        uc.genderCheckedChange.postValue(gender.get() ? FEMALE : MALE);
