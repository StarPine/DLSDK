...
import com.dl.playfun.databinding.FragmentMineTraceGirlBinding;
        ...
        viewModel.uc.refreshTag.observe(this, new Observer<TraceEvent>() {
            ...
            public void onChanged(TraceEvent traceEvent) {
                ...
                if (traceEvent.getSelIdx() == 0) {
                    String val = StringUtils.getString(R.string.mine_my_likes);
                    ...
                    String val = StringUtils.getString(R.string.mine_my_visitors_many);
