...
import com.dl.playfun.databinding.FragmentTrendDetailBinding;
...
public class TrendDetailFragment extends BaseToolbarFragment<FragmentTrendDetailBinding, TrendDetailViewModel> {
    ...
    public void initViewObservable() {
        ...
        videoPlayer = binding.detailVideoPlayer;
        viewModel.uc.playVideoView.observe(this, new Observer<Void>() {
            @Override
...
//                        .setAnimationStyle(R.style.RightPopAnim)
                ...
                if (viewModel.userId == viewModel.newsEntityObservableField.get().getUser().getId()) {
                    stop.setText(viewModel.newsEntityObservableField.get().getBroadcast().getIsComment() == 1 ? getString(R.string.open_comment) : getString(R.string.fragment_issuance_program_no_comment));
                } else {
                ...
                mCirclePop.findViewById(R.id.tv_detele).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        MVDialog.getInstance(TrendDetailFragment.this.getContext())
                                .setContent(getString(R.string.comfirm_delete_trend))
