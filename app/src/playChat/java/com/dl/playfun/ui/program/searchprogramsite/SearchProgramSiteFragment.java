...
import static com.dl.playfun.ui.radio.issuanceprogram.IssuanceProgramFragment.ARG_ADDRESS;
import static com.dl.playfun.ui.radio.issuanceprogram.IssuanceProgramFragment.ARG_ADDRESS_LAT;
import static com.dl.playfun.ui.radio.issuanceprogram.IssuanceProgramFragment.ARG_ADDRESS_LNG;
import static com.dl.playfun.ui.radio.issuanceprogram.IssuanceProgramFragment.ARG_ADDRESS_NAME;
import static com.dl.playfun.ui.radio.issuanceprogram.IssuanceProgramFragment.ARG_CHOOSE_CITY;
    ...
    public void initViewObservable() {
        ...
        viewModel.uc.clickResult.observe(this, new Observer() {
            ...
            public void onChanged(Object position) {
                Bundle bundle = new Bundle();
                bundle.putParcelable(ARG_CHOOSE_CITY, viewModel.chooseCity.get());
                bundle.putString(ARG_ADDRESS_NAME, viewModel.observableList.get((Integer) position).name.get());
                bundle.putString(ARG_ADDRESS, viewModel.observableList.get((Integer) position).address.get());
                if (viewModel.observableList.get((Integer) position).lat.get() != null) {
                    bundle.putDouble(ARG_ADDRESS_LAT, viewModel.observableList.get((Integer) position).lat.get());
                }
                if (viewModel.observableList.get((Integer) position).lng.get() != null) {
                    bundle.putDouble(ARG_ADDRESS_LNG, viewModel.observableList.get((Integer) position).lng.get());
                }
