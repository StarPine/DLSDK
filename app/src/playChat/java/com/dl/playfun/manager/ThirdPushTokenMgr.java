...
import static com.dl.playfun.app.AppConfig.GOOGLE_FCM_PUSH_BUZID;
...
public class ThirdPushTokenMgr {
    ...
    public void setPushTokenToTIM() {
        ...
        V2TIMOfflinePushConfig v2TIMOfflinePushConfig = new V2TIMOfflinePushConfig(GOOGLE_FCM_PUSH_BUZID, token);
        V2TIMManager.getOfflinePushManager().setOfflinePushConfig(v2TIMOfflinePushConfig, new V2TIMCallback() {
            @Override
            public void onError(int code, String desc) {
                KLog.d(TAG, "setOfflinePushToken err code = " + code + "; desc = " + desc + "; GOOGLE_FCM_PUSH_BUZID = " + GOOGLE_FCM_PUSH_BUZID + ";token = " + token);
            }
