...
public interface HttpDataSource {
     ...
     * @return
     */
    Observable<BaseResponse> recommendMsg(Integer type);
     ...
     * @return
     */
    Observable<BaseDataResponse<ThemeItemEntity>> getThemeDetail(int id);
     ...
     * 删除消息
     *
     * @param type 类型 system面具消息 sign报名消息 give点赞消息 evaluate评价消息 comment评论消息 broadcast电台消息 apply查看申请消息 profit收入消息
     * @param id   消息ID
     * @return
     */
     ...
     * @return
     */
    Observable<BaseResponse> likeRecommendCall(List<Integer> userIds);
