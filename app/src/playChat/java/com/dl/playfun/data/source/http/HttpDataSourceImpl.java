...
import com.dl.playfun.entity.GetInviteCodeEntity;
...
public class HttpDataSourceImpl implements HttpDataSource {
    ...
    @Override
    public Observable<BaseDataResponse<BroadcastListEntity>> getBroadcastHome(Integer sex, Integer city_id, Integer theme_id, Integer is_online, Integer is_collect, Integer type, Integer page) {
        return apiService.getBroadcastHome(sex, city_id, theme_id, is_online, is_collect, type, page);
    }
    ...
    @Override
    public Observable<BaseResponse> recommendMsg(Integer type) {
        return apiService.recommendMsg(type);
    }

    @Override
    public Observable<BaseDataResponse<MessageTagEntity>> recommendMsg() {
        return apiService.recommendMsg();
    }
    ...
    @Override
    public Observable<BaseDataResponse<ThemeItemEntity>> getThemeDetail(int id) {
        return apiService.getThemeDetail(id);
    }

    @Override
    public Observable<BaseDataResponse<ThemeAdEntity>> getThemeAdList() {
        return apiService.getThemeAdList();
    }
    ...
    public Observable<BaseListDataResponse<ParkItemEntity>> homeList(
            ...
            Double latitude,
            Integer page) {
        return apiService.homeListGet(cityId, type, isOnline, sex, searchName, longitude, latitude, page, "v2");
    }
    ...
    @Override
    public Observable<BaseResponse> updateUserData(String nickname, List<Integer> permanent_city_ids, String birthday, String occupation, List<Integer> program_ids, List<Integer> hope_object_ids, String weixin, String insgram, Integer is_weixin_show, Integer height, Integer weight, String desc) {
        return apiService.updateUserData(nickname, permanent_city_ids, birthday, occupation, program_ids, hope_object_ids, weixin, insgram, is_weixin_show, height, weight, desc);
    }
    ...
    @Override
    public Observable<BaseDataResponse<MyCardOrderEntity>> myCardOrder(String orderNumber) {
        return apiService.myCardOrder(orderNumber);
    }

    @Override
    public Observable<BaseResponse> myCardNotify(String orderNumber) {
        return apiService.myCardNotify(orderNumber);
    }
    ...
    @Override
    public Observable<BaseResponse> paySuccessNotify(String packageName, String orderNumber, String productId, String token, int type, Integer event) {
    ...
    @Override
    public Observable<BaseResponse> coinCashOut() {
        return apiService.coinCashOut();
    }

    @Override
    public Observable<BaseDataResponse<GetInviteCodeEntity>> getInviteCode() {
        return apiService.getInviteCode();
    }

    @Override
    public Observable<BaseResponse> checkInviteCode(String code) {
        return apiService.checkInviteCode(code);
    }
    ...
    @Override
    public Observable<BaseDataResponse<WithdrawNumberEntity>> getWithdrawNumber() {
        return apiService.getWithdrawNumber();
    }

    @Override
    public Observable<BaseDataResponse<List<RankListItemEntity>>> gerRankList() {
        return apiService.gerRankList();
    }

    @Override
    public Observable<BaseDataResponse<MessageChatNumberEntity>> isMessageChat(int userId) {
        return apiService.isMessageChat(userId);
    }

    @Override
    public Observable<BaseResponse> useMessageChat(int userId) {
        return apiService.useMessageChat(userId);
    }
    ...
    @Override
    public Observable<BaseDataResponse<List<BannerItemEntity>>> getBanner(int adType, int position) {
        return apiService.getBanner(adType, position);
    }
    ...
    @Override
    public Observable<BaseDataResponse<LikeRecommendEntity>> getLikeRecommend() {
        return apiService.getLikeRecommend();
    }

    @Override
    public Observable<BaseResponse> likeRecommendCall(List<Integer> userIds) {
        return apiService.likeRecommendCall(userIds);
    }
}
