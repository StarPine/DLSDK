...
import com.dl.playfun.ui.login.facerecognitionfailed.FaceRecognitionFailedViewModel;
import com.dl.playfun.ui.login.facerecognitionsuccess.FaceRecognitionSuccessViewModel;
import com.dl.playfun.ui.login.profile.ProfileViewModel;
...
import com.dl.playfun.ui.mine.address.AddressEditViewModel;
import com.dl.playfun.ui.mine.address.list.AddressListViewModel;
import com.dl.playfun.ui.mine.audio.TapeAudioViewModel;
import com.dl.playfun.ui.mine.bindmobile.BindMobileViewModel;
...
import com.dl.playfun.ui.mine.choosesex.ChooseSexViewModel;
...
import com.dl.playfun.ui.mine.setting.CommunityAccountModel;
import com.dl.playfun.ui.mine.setting.MeSettingViewModel;
import com.dl.playfun.ui.mine.setting.SettingViewModel;
import com.dl.playfun.ui.mine.task.TaskCenterViewModel;
import com.dl.playfun.ui.mine.task.fukubukuro.FukubukuroViewModel;
import com.dl.playfun.ui.mine.task.golddetail.GoldDetailViewModel;
import com.dl.playfun.ui.mine.task.main.TaskMainViewModel;
import com.dl.playfun.ui.mine.task.record.TaskExchangeRecordViewModel;
import com.dl.playfun.ui.mine.task.record.list.ExchangeRecordListViewModel;
import com.dl.playfun.ui.mine.task.webview.FukubuViewModel;
...
import com.dl.playfun.ui.radio.publishdynamic.PublishDynamicViewModel;
import com.dl.playfun.ui.radio.radiohome.RadioViewModel;
import com.dl.playfun.ui.splash.SplashViewModel;
...
import com.dl.playfun.ui.userdetail.remark.RemarkUserViewModel;
...
import com.dl.playfun.ui.webview.PlayGameViewModel;
import com.dl.playfun.ui.webview.PlayGameViewModel1;
...
public class AppViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        ...
        } else if (modelClass.isAssignableFrom(BindMobileViewModel.class)) {
            return (T) new BindMobileViewModel(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(PublishDynamicViewModel.class)) {
            return (T) new PublishDynamicViewModel(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(RemarkUserViewModel.class)) {
            return (T) new RemarkUserViewModel(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(ProgramListViewModel.class)) {
            return (T) new ProgramListViewModel(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(FaceRecognitionSuccessViewModel.class)) {
            return (T) new FaceRecognitionSuccessViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(FaceRecognitionFailedViewModel.class)) {
            return (T) new FaceRecognitionFailedViewModel(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(TaskCenterViewModel.class)) {
            return (T) new TaskCenterViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(GoldDetailViewModel.class)) {
            return (T) new GoldDetailViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(TaskExchangeRecordViewModel.class)) {
            return (T) new TaskExchangeRecordViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(ExchangeRecordListViewModel.class)) {
            return (T) new ExchangeRecordListViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(AddressEditViewModel.class)) {
            return (T) new AddressEditViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(AddressListViewModel.class)) {
            return (T) new AddressListViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(FukubukuroViewModel.class)) {
            return (T) new FukubukuroViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(PlayGameViewModel.class)) {
            return (T) new PlayGameViewModel(mApplication, mRepository);
        } else if (modelClass.isAssignableFrom(PlayGameViewModel1.class)) {
            return (T) new PlayGameViewModel1(mApplication, mRepository);
        ...
        } else if (modelClass.isAssignableFrom(TaskMainViewModel.class)) {
            return (T) new TaskMainViewModel(mApplication, mRepository);
