    ...
    public static String getFriendlyTimeSpan(String time) {
        if (time != null) {
            try {
                ...
                if (span < 1000) {
                    return StringUtils.getString(R.string.just);
                } else if (span < MIN) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.seconds_ago), span / SEC);
                } else if (span < HOUR) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.minutes_ago), span / MIN);
                } else if (span < DAY) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.hours_ago), span / HOUR);
                } else if (span < WEEK) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.daily_ago), span / DAY);
                } else if (span < MONTH) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.weeks_ago), span / WEEK);
                } else if (span < YEAR) {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.month_ago), span / MONTH);
                } else {
                    return String.format(Locale.getDefault(), StringUtils.getString(R.string.year_ago), span / YEAR);
                }
