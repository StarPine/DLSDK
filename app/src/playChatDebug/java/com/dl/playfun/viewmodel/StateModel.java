...
import com.dl.playfun.exception.EmptyException;
...
public class StateModel extends BaseObservable {
    ...
    public ObservableField<String> emptyText = new ObservableField<>(StringUtils.getString(R.string.empty_state_no_data));
    ...
    public String getCurrentStateLabel() {
        switch (emptyState) {
            ...
            case EmptyState.NET_ERROR:
                return StringUtils.getString(R.string.empty_state_check_network);
            case EmptyState.NOT_AVAILABLE:
                return StringUtils.getString(R.string.empty_state_server_error);
            default:
                return StringUtils.getString(R.string.empty_state_no_data);
        }
    }
