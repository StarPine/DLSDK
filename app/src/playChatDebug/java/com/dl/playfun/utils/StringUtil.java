...
public class StringUtil {
    ...
    public static String getWeekengString(int weekeng, Context context) {
        ...
        switch (weekeng) {
            case 1:
                str = StringUtils.getString(R.string.monday);
                break;
            case 2:
                str = StringUtils.getString(R.string.tuesday);
                break;
            case 3:
                str = StringUtils.getString(R.string.wednesday);
                break;
            case 4:
                str = StringUtils.getString(R.string.thursday);
                break;
            case 5:
                str = StringUtils.getString(R.string.friday);
                break;
            case 6:
                str = StringUtils.getString(R.string.saturday);
                break;
            case 7:
                str = StringUtils.getString(R.string.sunday);
                break;
        }
        return str;
    }
    ...
    public static String getDatingObjItem(int id) {
        String str = StringUtils.getString(R.string.user_detail_ta_dynamic);
        switch (id) {
            case 1:
                str = StringUtils.getString(R.string.mood_item_id1);
                break;
            case 2:
                str = StringUtils.getString(R.string.mood_item_id2);
                break;
            case 3:
                str = StringUtils.getString(R.string.mood_item_id3);
                break;
            case 4:
                str = StringUtils.getString(R.string.mood_item_id4);
                break;
            case 5:
                str = StringUtils.getString(R.string.mood_item_id5);
                break;
            case 6:
                str = StringUtils.getString(R.string.mood_item_id6);
                break;
        }
        return str;
    }
