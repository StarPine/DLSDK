...
import com.dl.playfun.ui.mine.task.webview.FukubukuroViewFragment;
...
public class TwDollarMoneyViewModel extends BaseViewModel<AppRepository> {
    ...
    public ObservableField<String> withdrawString = new ObservableField<>(StringUtils.getString(R.string.withdraw));
        ...
        model.getUserProfitPageInfo(userId.longValue(), page, 20)
                ...
                .subscribe(new BaseObserver<BaseDataResponse<UserProfitPageEntity>>() {
                    ...
                    if(!ObjectUtils.isEmpty(listData) && listData.size()>0){
                        ...
                        withdrawString.set(StringUtils.getString(R.string.withdraw));
                        ...
                        if(observableList==null|| observableList.size()<1){
                            ...
                            withdrawString.set(StringUtils.getString(R.string.dialong_coin_doing_task));
                            stateModel.emptyText.set(StringUtils.getString(R.string.tw_money_empty));
