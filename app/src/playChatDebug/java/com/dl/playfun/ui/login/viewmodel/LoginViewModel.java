package com.dl.playfun.ui.login.viewmodel;
...
import com.dl.playfun.ui.login.mobilelogin.MobileLoginFragment;
import com.dl.playfun.ui.login.register.RegisterFragment;
import com.dl.playfun.ui.main.MainFragment;
import com.dl.playfun.ui.mine.bindmobile.BindMobileFragment;
...
public class LoginViewModel extends BaseViewModel<AppRepository>  {
     ...
     * 手机号登录登录按钮的点击事件
     */
    public BindingCommand mobileLoginOnClickCommand = new BindingCommand(() -> mobileLogin());
        ...
        model.authLoginPost(id, type, email, avatar, nickname, ApiUitl.getAndroidId(), business)
                ...
                .subscribe(new BaseObserver<BaseDataResponse<Map<String, String>>>() {
                    ...
                    public void onSuccess(BaseDataResponse<Map<String, String>> mapBaseDataResponse) {
                        ...
                        if (dataToken.get("bind_phone") == null || Integer.parseInt(dataToken.get("bind_phone")) == 0) {
                            start(BindMobileFragment.class.getCanonicalName());
                        } else {
                            loadProfile();
                        }
                    }
