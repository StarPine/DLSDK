        ...
        viewModel.uc.clickMore.observe(this, o -> {
            ...
            if (type.equals(RadioRecycleType_New)) {
                if (viewModel.userId == ((TrendItemViewModel) viewModel.observableList.get(position)).newsEntityObservableField.get().getUser().getId()) {
                    stop.setText(((TrendItemViewModel) viewModel.observableList.get(position)).newsEntityObservableField.get().getBroadcast().getIsComment() == 0 ? getString(R.string.fragment_issuance_program_no_comment) : getString(R.string.open_comment));
                    isSelf = true;
                } else {
                ...
                if (viewModel.userId == ((ProgramItemViewModel) viewModel.observableList.get(position)).topicalListEntityObservableField.get().getUserId()) {
                    stop.setText(((ProgramItemViewModel) viewModel.observableList.get(position)).topicalListEntityObservableField.get().getBroadcast().getIsComment() == 0 ? getString(R.string.fragment_issuance_program_no_comment) : getString(R.string.open_comment));
