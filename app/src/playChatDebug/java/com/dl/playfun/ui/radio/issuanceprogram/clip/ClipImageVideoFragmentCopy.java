...
public class ClipImageVideoFragmentCopy extends BaseFragment<FragmentClipImageVideoBinding, ClipImageVideoViewModel> implements CustomAdapt, TextureView.SurfaceTextureListener, HorizontalListView.OnScrollCallBack, SizeChangedNotifier.Listener,
    ...
    public static final String TAG = ClipImageVideoFragmentCopy.class.getSimpleName();
    ...
    private boolean mInputVideoPathUpdate = false;
        ...
        public boolean handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case PAUSE_VIDEO:
                    ...
                    break;
                case PLAY_VIDEO:
                    Log.e("mPlayer对象是否为空",String.valueOf(mPlayer==null));
                    if (mPlayer != null) {
    ...
    public void initData() {
        ...
        crop.setCropCallback(new ClipImageVideoFragmentCopy.CropCallbacks());
        initAliYun();
        initSurface();
            ...
            public void onChanged(Void unused) {
                if($custonEntity!=null){
                    if($custonEntity.getMediaType()==1){
                        ...
                        ApiUitl.saveBitmap(getContext(), newBitmap, "PlayChat" + ApiUitl.getDateTimeFileName() + ".jpg", new ApiUitl.CallBackUploadFileNameCallback() {
                            @Override
...
//                            .build();
    ...
    private void getData(String VideoPath) {
        if(mInputVideoPath!=null && VideoPath.equals(mInputVideoPath)){
            mInputVideoPathUpdate = false;
            return;
        }else{
            mInputVideoPathUpdate = true;
        }
...
//        resizeFrame();
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        Log.e("视图更新","11111111111111");
        if (mInputVideoPathUpdate) {
            mSurface = new Surface(surface);
            mPlayer = AliyunSVideoPlayerCreator.createPlayer();
            mPlayer.init(getContext());
