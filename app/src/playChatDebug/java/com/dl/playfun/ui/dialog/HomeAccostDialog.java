...
//        item_lottie6.setImageDrawable(getContext().getDrawable(R.drawable.dialog_accost_submit));
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (submit) {
                    if (isCountdown) {
                        ToastUtils.showShort(R.string.text_time_not_up);
                        return;
                    } else {
                        submitAccostList();
                    }
                } else {
                    ToastUtils.showShort(R.string.text_run_out);
                    return;
                }
                    ...
                    public void onSuccess(BaseDataResponse<AccostEntity> accostEntityBaseDataResponse) {
                        ...
                        if (!ObjectUtils.isEmpty(accostEntity)) {
                            ...
                            if (submit) {
                                ...
                                exp_time.setText(mContext.getString(R.string.text_accost_empty));
                            }
                            ...
                            if ($listData != null) {
                                ...
                                item_entity_text1.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity1.getAge()) + " " + SystemDictUtils.getCityById(itemEntity1.getCityId()));
                                item_entity_text2.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity2.getAge()) + " " + SystemDictUtils.getCityById(itemEntity2.getCityId()));
                                item_entity_text3.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity3.getAge()) + " " + SystemDictUtils.getCityById(itemEntity3.getCityId()));
                                item_entity_text4.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity4.getAge()) + " " + SystemDictUtils.getCityById(itemEntity4.getCityId()));
                                item_entity_text5.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity5.getAge()) + " " + SystemDictUtils.getCityById(itemEntity5.getCityId()));
                                item_entity_text6.setText(String.format(StringUtils.getString(R.string.mine_age), itemEntity6.getAge()) + " " + SystemDictUtils.getCityById(itemEntity6.getCityId()));
    ...
    private void submitAccostList() {
        ...
        if (!ObjectUtils.isEmpty(dataAccessList) && dataAccessList.size() > 0) {
            ...
            ToastUtils.showShort(R.string.text_accost_error2);
        }
    ...
    private void downTime() {
        ...
        downTimer = new CountDownTimer(downTime, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                String hintText = StringUtils.getString(R.string.text_accost_error3);
                exp_time.setTextColor(ColorUtils.getColor(R.color.accost_down_time));
                exp_time.setText(hintText + time);
                exp_time.setVisibility(View.VISIBLE);
        ...
        AppContext.instance().appRepository.putAccostList(userIds)
                ...
                .subscribe(new BaseObserver<BaseResponse>() {
                    ...
                    public void onSuccess(BaseResponse baseResponse) {
                        ...
                        lottieAnimationView();
                        ToastUtils.showShort(R.string.text_accost_success);
                        getAccountList(false);
                    }
