...
public class CommentItemViewModel extends MultiItemViewModel<BaseViewModel> {
    ...
    public String getMessageContent() {
        String content = "";
        if (isShow || isMore) {
            content = String.format("<font color='#666666' size='24'>%s</font>", getString(R.string.check_more_commment));
            ...
            content = String.format("<font color='#A72DFE' size='24' >%s</font> " + StringUtils.getString(R.string.recovery), commentBeanObservableField.get().getUser().getNickname()) +
