...
import com.dl.playfun.databinding.FragmentLikeListBinding;
    ...
    public void initViewObservable() {
        viewModel.uc.clickDelLike.observe(this, new Observer<Integer>() {
            ...
            public void onChanged(Integer unused) {
                TraceDialog.getInstance(LikeListFragment.this.getContext())
                        .setTitle(getString(R.string.mine_trace_delike))
                        .setCannelText(getString(R.string.mine_trace_delike_cannel))
        ...
        viewModel.uc.loadRefresh.observe(this, new Observer<Void>() {
            ...
            public void onChanged(Void unused) {
                binding.title.setText(String.format(StringUtils.getString(R.string.mine_trace_man_title2), viewModel.totalCount));
            }
        });
