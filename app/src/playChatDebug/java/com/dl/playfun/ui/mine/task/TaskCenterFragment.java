package com.dl.playfun.ui.mine.task;
...
import com.dl.playfun.ui.mine.task.record.TaskExchangeRecordFragment;
 ...
 * Description: 任务中心
 */
public class TaskCenterFragment extends BaseToolbarFragment<TaskCenterFragmentBinding, TaskCenterViewModel> implements CustomAdapt {
    ...
    public int initContentView(LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        AutoSizeCompat.autoConvertDensityOfGlobal(TaskCenterFragment.this.getResources());
    ...
    public void initSignDay(EjectEntity ejectEntity) {
        ...
        if (sexMale) {//男生
            ...
            if (maleConfig1.getType() == 1) {
                ...
                binding.day1Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig1.getValue()));
            } else {
            ...
            if (maleConfig2.getType() == 1) {
                ...
                binding.day2Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig2.getValue()));
            } else {
            ...
            if (maleConfig3.getType() == 1) {
                ...
                binding.day3Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig3.getValue()));
            } else {
            ...
            if (maleConfig4.getType() == 1) {
                ...
                binding.day4Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig4.getValue()));
            } else {
            ...
            if (maleConfig5.getType() == 1) {
                ...
                binding.day5Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig5.getValue()));
            } else {
            ...
            if (maleConfig6.getType() == 1) {
                ...
                binding.day6Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig6.getValue()));
            } else {
            ...
            if (day_ed >= 7) {
                ...
                binding.day7Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), maleConfig7.getValue()));
            ...
            binding.day1Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(0)));
            binding.day2Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(1)));
            binding.day3Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(2)));
            binding.day4Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(3)));
            binding.day5Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(4)));
            binding.day6Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(5)));
            binding.day7Fen.setText(String.format(StringUtils.getString(R.string.radio_daily_atendance_fen), ejectEntity.getFemaleConfig().get(6)));
            if (day_ed == 0) {
                binding.day1Img.setVisibility(View.VISIBLE);
                binding.day2Img.setVisibility(View.VISIBLE);
                binding.day3Img.setVisibility(View.VISIBLE);
