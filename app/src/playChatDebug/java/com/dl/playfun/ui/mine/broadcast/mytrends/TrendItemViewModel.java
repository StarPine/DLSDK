    ...
    public BindingCommand commentClick = new BindingCommand(() -> {
        try {
            ...
            if (viewModel instanceof MyTrendsViewModel) {
                ...
                } else if (newsEntityObservableField.get().getUser().getSex() == sex) {
                    if (sex == MALE) {
    ...
    public BindingCommand avatarClick = new BindingCommand(() -> {
        try {
            ...
            if (newsEntityObservableField.get().getUser().getSex() == sex) {
                ToastUtils.showShort(newsEntityObservableField.get().getUser().getSex() == FEMALE ? StringUtils.getString(R.string.madam_ont_check_madam_detail) : StringUtils.getString(R.string.man_ont_check_man_detail));
            } else {
...
//                ImageItemViewModel ivItem = new ImageItemViewModel(viewModel, newsEntityObservableField.get().getImages().get(i), i, newsEntityObservableField.get().getImages());
