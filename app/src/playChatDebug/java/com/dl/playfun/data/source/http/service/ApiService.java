...
public interface ApiService {
    ...
    */
     ...
     * 每日推荐弹窗事件提交
     *
     * @param type 2查看 3点击关闭
     * @return
     */
    @POST("api/v2/recommendMsg")
    Observable<BaseResponse> recommendMsg(@Query("type") Integer type);
     ...
     * @return
     */
    @GET("api/v2/recommendMsg")
    Observable<BaseDataResponse<MessageTagEntity>> recommendMsg();
     ...
     */
    @GET("api/v2/theme/{id}")
    Observable<BaseDataResponse<ThemeItemEntity>> getThemeDetail(
            @Path("id") int id
    );

    /**
     * @return io.reactivex.Observable<com.dl.playfun.data.source.http.response.BaseDataResponse < com.dl.playfun.entity.ThemeAdEntity>>
     * @Author 彭石林
     * @Description 获取新的主题列表+广告列表
     ...
     **/
    @GET("api/v2/theme")
    Observable<BaseDataResponse<ThemeAdEntity>> getThemeAdList();
...
//@GET("api/v2/config")
    ...
    Observable<BaseDataResponse<MyCardOrderEntity>> myCardOrder(
            @Field("order_number") String orderNumber
    );

    @FormUrlEncoded
    @POST("api/mycard/notify")
    Observable<BaseResponse> myCardNotify(
            @Field("order_number") String orderNumber
    );
     ...
     */
    @POST("api/cashOut")
    Observable<BaseResponse> coinCashOut();
    ...
    Observable<BaseDataResponse<GetInviteCodeEntity>> getInviteCode();
    ...
    Observable<BaseDataResponse<WithdrawNumberEntity>> getWithdrawNumber();
     ...
     */
    @GET("api/top")
    Observable<BaseDataResponse<List<RankListItemEntity>>> gerRankList();
    ...
    Observable<BaseDataResponse<MessageChatNumberEntity>> isMessageChat(
    ...
    Observable<BaseResponse> useMessageChat(
            @Field("user_id") int userId
    );
     ...
     * 获取广告
     *
     * @param adType   广告类型  2弹窗广告(之前api/banner接口数据) 4浮窗广告
     * @param position 展示位置  1用户列表页 2广播列表页 3会员介绍页（VIP套餐页）
     * @return
     */
    @GET("api/alert")
    Observable<BaseDataResponse<List<BannerItemEntity>>> getBanner(
            @Query("ad_type") int adType,
     ...
     */
    @GET("api/call")
    Observable<BaseDataResponse<LikeRecommendEntity>> getLikeRecommend();
    ...
    @FormUrlEncoded
    @POST("api/call")
    Observable<BaseResponse> likeRecommendCall(
            @Field("user_ids[]") List<Integer> userIds
    );
}
