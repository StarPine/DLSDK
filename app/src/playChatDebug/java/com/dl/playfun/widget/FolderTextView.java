...
public class FolderTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    // 默认收起文字
    private static final String DEFAULT_FOLD_TEXT = StringUtils.getString(R.string.fold);
    // 默认展开文字
    private static final String DEFAULT_UNFOLD_TEXT = StringUtils.getString(R.string.unfold);
    // 默认固定行数
    ...
    // 点击处理
    private final ClickableSpan clickSpan = new ClickableSpan() {
        @Override
