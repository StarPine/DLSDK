...
public class MyprogramViewModel extends BaseRefreshViewModel<AppRepository> {
    ...
    public MyprogramViewModel(@NonNull Application application, AppRepository model) {
        ...
        stateModel.setEmptyRetryCommand(StringUtils.getString(R.string.playfun_my_program_no_show), null, null);
    }
    ...
    public void setComment(int posion) {
        model.setComment(observableList.get(posion).topicalListEntityObservableField.get().getBroadcast().getId(),
                ...
                .subscribe(new BaseObserver<BaseResponse>() {
                    ...
                    public void onSuccess(BaseResponse response) {
                        dismissHUD();
                        ToastUtils.showShort(observableList.get(posion).topicalListEntityObservableField.get().getBroadcast().getIsComment() == 1 ? StringUtils.getString(R.string.playfun_open_comment_success) : StringUtils.getString(R.string.playfun_close_success));
