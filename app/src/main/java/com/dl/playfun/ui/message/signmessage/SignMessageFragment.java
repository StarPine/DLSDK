...
import com.dl.playfun.databinding.FragmentSignMessageBinding;

/**
 * @author wulei
 */
public class SignMessageFragment extends BaseRefreshToolbarFragment<FragmentSignMessageBinding, SignMessageViewModel> {
    ...
    public SignMessageViewModel initViewModel() {
        ...
        return ViewModelProviders.of(this, factory).get(SignMessageViewModel.class);
    }
