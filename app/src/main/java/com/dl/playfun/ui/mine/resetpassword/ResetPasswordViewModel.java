    ...
    public BindingCommand resetOnClickCommand = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            if (TextUtils.isEmpty(mobile.get())) {
                ToastUtils.showShort(R.string.playfun_please_iput_phone);
                return;
            }
            ...
            if (TextUtils.isEmpty(password.get())) {
                ToastUtils.showShort(R.string.playfun_please_input_new_password);
                return;
            }
                        ...
                        public void onSuccess(BaseResponse response) {
                            ...
                            CountDownTimer timer = new CountDownTimer(60 * 1000, 1000) {
                                ...
                                public void onTick(long millisUntilFinished) {
                                    isDownTime = true;
                                    downTimeStr.set(StringUtils.getString(R.string.playfun_again_send) + "（" + millisUntilFinished / 1000 + "）");
                                }

                                @Override
                                public void onFinish() {
                                    isDownTime = false;
                                    downTimeStr.set(StringUtils.getString(R.string.playfun_again_send));
                                }
                            }.start();
                        }
