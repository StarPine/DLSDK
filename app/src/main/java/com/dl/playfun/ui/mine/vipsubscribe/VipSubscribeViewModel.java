...
//    private void querySubs(List<VipPackageItemEntity> vipPackages) {
//        List<String> skuList = new ArrayList<>();
//        for (VipPackageItemEntity vipPackage : vipPackages) {
//            if (vipPackage.getGoogleGoodsId() != null) {
//                skuList.add(vipPackage.getGoogleGoodsId());
//            }
//        }
...
//                                        if (skuDetails.getSku().equals(vipPackage.getGoogleGoodsId())) {
//                                            VipSubscribeItemViewModel item = new VipSubscribeItemViewModel(VipSubscribeViewModel.this, vipPackage, skuDetails);
//                                            observableList.add(item);
//                                            if (vipPackage.getIsRecommend() == 1) {
//                                                vipPackage.setSelected(true);
//                                                pay_good_day = vipPackage.getActualValue();
//                                                //pay_good_day = observableList.get(i).itemEntity.get().getActualValue();
//                                                checkedVipPackageItemEntity.set(vipPackage);
//                                                selectedPosition.set(i);
//                                            }
//                                            break;
...
//                        for (int i = 0; i < vipPackages.size(); i++) {
//                            VipPackageItemEntity vipPackage = vipPackages.get(i);
//                            VipSubscribeItemViewModel item = new VipSubscribeItemViewModel(VipSubscribeViewModel.this, vipPackage, null);
//                            observableList.add(item);
//                            if (vipPackage.getIsRecommend() == 1) {
//                                vipPackage.setSelected(true);
