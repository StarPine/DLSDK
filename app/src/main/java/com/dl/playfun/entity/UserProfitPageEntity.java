 ...
 * Description: This is UserProfitPageEntity
 */
public class UserProfitPageEntity {
    ...
    public class CustomProfitList{
        ...
        private List<UserProfitPageInfoEntity> data;
        ...
        public List<UserProfitPageInfoEntity> getData() {
            return data;
        }

        public void setData(List<UserProfitPageInfoEntity> data) {
            this.data = data;
        }
    }
}
