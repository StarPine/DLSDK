...
public class BasicToolbar extends Toolbar implements View.OnClickListener {
    ...
    public BasicToolbar(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public BasicToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface ToolbarListener {
         ...
         * @param toolbar
         */
        void onBackClick(BasicToolbar toolbar);
    }
}
