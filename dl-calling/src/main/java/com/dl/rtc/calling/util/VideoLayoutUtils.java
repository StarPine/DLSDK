...
/**
 * Author: 彭石林
 * Time: 2022/11/5 15:40
 * Description: This is VideoLayoutUtils
 */
public class VideoLayoutUtils {
    ...
    public static ArrayList<RelativeLayout.LayoutParams> initFloatParamList(Context context, int layoutWidth, int layoutHeight) {
        ...
        final int midMargin = VideoLayoutUtils.dip2px(context, 10);
        final int lrMargin = VideoLayoutUtils.dip2px(context, 15);
        final int bottomMargin = VideoLayoutUtils.dip2px(context, 50);
        final int subWidth = VideoLayoutUtils.dip2px(context, 120);
        final int subHeight = VideoLayoutUtils.dip2px(context, 180);
        for (int i = 2; i >= 0; i--) {
