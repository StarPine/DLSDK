    ...
    public static CallModel convert2VideoCallData(V2TIMMessage msg) {
        ...
        try {
            ...
            if (extraMap != null
                    ...
                    && ((Double)extraMap.get(CallModel.SIGNALING_EXTRA_KEY_VERSION)).intValue() > TUIConversationConstants.version) {
            ...
            TUIConversationLog.e(TAG, "convert2VideoCallData exception:" + e);
        }
        return callModel;
    }
}