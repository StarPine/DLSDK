...
public class TUICallVideoView extends BaseTUICallView {
    ...
    protected void initView() {
        ...
        mOpenCameraLl = findViewById(R.id.ll_open_camera);
        mOpenCameraImg = findViewById(R.id.img_camera);
        mSponsorUserVideoTag = findViewById(R.id.tv_sponsor_video_tag);
        mViewSwitchAudioCall = findViewById(R.id.ll_switch_audio_call);
        mTvHangup = findViewById(R.id.tv_hangup);
