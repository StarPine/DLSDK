...
public class ChatView extends LinearLayout  implements IChatLayout {
    ...
    private final ChatPresenter.TypingListener mTypingListener = new ChatPresenter.TypingListener() {
        @Override
    ...
    public void setChatInfo(ChatInfo chatInfo) {
        ...
        isGroup = !TUIChatUtils.isC2CChat(chatInfo.getType());
    ...
    public interface ForwardSelectActivityListener {
        void onStartForwardSelectActivity(int mode, List<MessageInfo> msgIds);
    }
    //彭石林临时添加
}
