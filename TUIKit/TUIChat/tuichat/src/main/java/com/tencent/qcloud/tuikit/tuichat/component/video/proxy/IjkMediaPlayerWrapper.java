...
public class IjkMediaPlayerWrapper implements IPlayer {
    ...
    public IjkMediaPlayerWrapper() {
        try {
            ...
            Log.i(TAG, "no IjkMediaPlayer: " + e.getMessage());
        }
    }
    ...
    private Object invoke(String methodName, Object... args) {
        try {
            ...
            Log.e(TAG, "invoke failed: " + methodName + " error: " + e.getCause());
        }
        return null;
    }
    ...
    private class ListenerHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (mListener instanceof OnInfoListener && TextUtils.equals("onInfo", method.getName())) {
                if ((int) args[1] == 10001) {
                    Log.i(TAG, "IMediaPlayer.MEDIA_INFO_VIDEO_ROTATION_CHANGED");
                }
                ...
                Log.i(TAG, "width: " + args[1] + " height: " + args[2]
