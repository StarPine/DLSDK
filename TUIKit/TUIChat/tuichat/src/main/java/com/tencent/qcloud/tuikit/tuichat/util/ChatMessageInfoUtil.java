...
public class ChatMessageInfoUtil {
    ...
    */
    ...
    public static MessageInfo buildForwardMessage(V2TIMMessage v2TIMMessage) {
        ...
        MessageInfo info = ChatMessageInfoUtil.createMessageInfo(forwardMessage);
...
//        customMessage.put("type","custom_call");
//        customMessage.put("status",callModel.callType);
//        customMessage.put("text",content);
