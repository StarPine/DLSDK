...
public class CropMediaActivity extends Activity {
    ...
    private void getData() {
        ...
        minVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_VIDEO_DURATION, 3000);
        ...
        minDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_DURATION, 3000);
                            ...
                            ThreadUtils.runOnSubThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    ThreadUtils.runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!rs) {
                                                ToastUtils.show(CropMediaActivity.this, "HEIF圖片轉化失敗，請重試!");
                                                return;
                                            }
